...
def main(batch_size, num_workers, epochs, load_weights=False):
    ...
    for epoch in range(1, epochs + 1):
        ...
        with torch.no_grad():
            ...
            for data in (pbar := tqdm(test_loader)):
                ...
                # evaluate
                y_pred = network.module.inference(y_logits, steps=10)
                logger["loss"].append(loss)
    ...
    ----------Tests with Ordered Retrieval------------
                      1       2       3       4       5
    -----------  ------  ------  ------  ------  ------
    Precision@k  46.651  43.174  41.194  39.692  38.518
    nDCG@k       46.651  43.987  42.447  41.283  40.371
    PSprec@k      7.019   7.510   7.989   8.405   8.786
    PSnDCG@k      7.019   7.364   7.679   7.940   8.169
    All Done!
...
if __name__ == '__main__':
    ...
    main(batch_size=64, num_workers=32, epochs=25, load_weights=True)
